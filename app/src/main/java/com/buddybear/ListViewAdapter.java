...
public class ListViewAdapter extends BaseAdapter {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			holder.Credit = (TextView) view.findViewById(R.id.ecredit);
		...
		holder.Name.setText("Course: "+weeklist.get(position).getName());
		holder.Semester.setText("Semester: "+weeklist.get(position).getSemester());
		holder.Grade.setText("Grade: "+weeklist.get(position).getGrade());
		holder.Credit.setText("Credit: "+weeklist.get(position).getCredit());
